...
void Detection::InitDetection(long nFrames, double nSec, int sf, int NCh, long ti, long *Indices, int agl, int tpref, int tpostf) {
  ...
  spikes_file.open("Detected Spikes");
...
void Detection::SetInitialParams(string positions_file_path, string neighbors_file_path, int num_channels, int num_recording_channels, int spike_delay, int spike_peak_duration,
                                 string file_name, int noise_duration, float noise_amp_percent,  int* _masked_channels, int max_neighbors, int inner_radius, bool to_localize, int thres,
  ...
  setInitialParameters(num_channels, num_recording_channels, spike_delay, spike_peak_duration, file_name, noise_duration,
                       noise_amp_percent, masked_channels, channel_positions, neighbor_matrix, max_neighbors, inner_radius, to_localize,
